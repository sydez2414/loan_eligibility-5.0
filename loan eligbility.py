...
with st.form("loan_form"):
    ...
    income = st.number_input("Pendapatan Bersih Bulanan (RM)", min_value=0.0, step=100.0, format="%.2f")
    commitment = st.number_input("Jumlah Komitmen Bulanan (RM)", min_value=0.0, step=50.0, format="%.2f")
